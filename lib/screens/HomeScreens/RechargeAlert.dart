...
class RechargeAlert extends StatefulWidget {
  RechargeAlert({Key key}) : super(key: key);

  @override
  _RechargeAlertState createState() => _RechargeAlertState();
}

class _RechargeAlertState extends State<RechargeAlert> {
  @override
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            Container(
                                              ...
                                              child: Padding(
                                                padding:  EdgeInsets.all(5.0),
                                                child: Text('Credit Left : -5',style: AppStyles.whiteTextStyle.copyWith(
